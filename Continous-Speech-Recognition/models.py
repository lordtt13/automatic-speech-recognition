...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr  9 13:12:37 2020

@author: tanmay
"""

from tensorflow.keras.models import Model
from tensorflow.keras.layers import Activation, Bidirectional, SimpleRNN, GRU, LSTM, Dropout
from tensorflow.keras.layers import BatchNormalization, Conv1D, Dense, Input, TimeDistributed
...
def rnn_model(input_dim, units, activation, output_dim = 29):
    ...
    simp_rnn = GRU(units, activation = activation, return_sequences = True, 
                   implementation = 2, name = 'rnn', dropout = 0.3)(input_data)
...
def final_model(input_dim,  
    ...
    for i in range(cnn_layers):
        ...
        if cnn_implementation=='BN-DR-AC':
            ...
            # Add (in order) Activation,Dropout and Batch Normalization
            nn = Activation(cnn_activation, name = 'act_'+ layer_name)(nn)
            nn = Dropout(cnn_dropout, name = 'drop_'+ layer_name)(nn)
            nn = BatchNormalization(name = 'bn_'+ layer_name)(nn)
